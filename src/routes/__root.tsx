...
export const Route = createRootRouteWithContext<RouterContext>()({
  head: () => ({
    meta: [
          {
            title: 'Hand-Drawn Scroll Saw Patterns – Ashola-Jesu Scroll Patterns',
          },
			{
				name: 'description',
				content: "Discover hand-drawn scroll saw patterns and inspirational art for DIYers, Scroll Sawyers, and crafters in Nigeria, the USA, UK, Canada, Australia, and beyond. Keywords: scroll saw patterns, hand-drawn scroll saw, Christian word art, DIY pattern downloads, global lcraft patterns, stay-at-home crafter, Nigeria scroll saw"
			},
          {
            charSet: 'UTF-8',
          },
...
function RootComponent() {
  ...
  return (
    <html lang="en">
      ...
      <body>
        <nav className="h-18 bg-primary-500 p-4 flex items-center justify-between">
